...
const submitHandler = (e) => {
  ...
  const formData = new FormData();  //{name:avinash, email: abiavianash443@gamil.com..}
...
const onChange = (e) => {
    if(e.target.name === "avatar"){
      const reader = new FileReader();  //its create new instance  of file reader
      reader.onload = () => {
        if(reader.readyState === 2) {    //indicted the reading is done
